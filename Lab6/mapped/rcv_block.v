...
module rcu ( clk, n_rst, new_packet_detected, packet_done, framing_error, 
  ...
  wire   n25, n26, n27, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15,
         n16, n17, n18, n19, n20, n21, n22, n23, n24, n28;
  wire   [2:0] state;
  ...
  INVX1 U8 ( .A(n8), .Y(sbc_clear) );
  MUX2X1 U9 ( .B(n9), .A(n10), .S(state[0]), .Y(n27) );
  NAND2X1 U10 ( .A(n10), .B(n11), .Y(n9) );
  OR2X1 U11 ( .A(n12), .B(n13), .Y(n26) );
  OAI22X1 U12 ( .A(framing_error), .B(n6), .C(n10), .D(n7), .Y(n13) );
  INVX1 U13 ( .A(n14), .Y(n10) );
  OAI21X1 U14 ( .A(state[0]), .B(n15), .C(n8), .Y(n12) );
  OAI21X1 U15 ( .A(n14), .B(n16), .C(n17), .Y(n25) );
  OAI21X1 U16 ( .A(n18), .B(n14), .C(state[2]), .Y(n17) );
  AOI21X1 U17 ( .A(framing_error), .B(state[0]), .C(state[1]), .Y(n18) );
  NAND2X1 U18 ( .A(n19), .B(state[0]), .Y(n16) );
  OAI21X1 U19 ( .A(n20), .B(n21), .C(n22), .Y(n14) );
  NAND3X1 U20 ( .A(n7), .B(n4), .C(n23), .Y(n22) );
  NOR2X1 U21 ( .A(new_packet_detected), .B(n24), .Y(n23) );
  INVX1 U22 ( .A(state[0]), .Y(n21) );
  AOI22X1 U23 ( .A(n19), .B(n28), .C(state[2]), .D(n6), .Y(n20) );
  INVX1 U24 ( .A(packet_done), .Y(n28) );
  INVX1 U25 ( .A(n15), .Y(n19) );
  NOR2X1 U26 ( .A(state[0]), .B(n11), .Y(load_buffer) );
  NAND2X1 U27 ( .A(state[1]), .B(state[2]), .Y(n11) );
  NAND2X1 U28 ( .A(n8), .B(n15), .Y(enable_timer) );
  NAND2X1 U29 ( .A(state[1]), .B(n4), .Y(n15) );
  NAND2X1 U30 ( .A(n24), .B(n4), .Y(n8) );
  INVX1 U31 ( .A(state[2]), .Y(n4) );
  INVX1 U32 ( .A(n6), .Y(n24) );
  NAND2X1 U33 ( .A(state[0]), .B(n7), .Y(n6) );
  INVX1 U34 ( .A(state[1]), .Y(n7) );
endmodule
...
module sr_9bit ( clk, n_rst, shift_strobe, serial_in, packet_data, stop_bit );
  ...
  flex_stp_sr_NUM_BITS9_SHIFT_MSB0 wrap ( .clk(clk), .n_rst(n_rst), 
...
module flex_counter_NUM_CNT_BITS4_1 ( clk, n_rst, clear, count_enable, 
  ...
  wire   n39, next_flag, n2, n3, n4, n5, n6, n12, n13, n14, n15, n16, n17, n18,
  ...
  NOR2X1 U9 ( .A(n2), .B(n3), .Y(next_flag) );
  NAND2X1 U10 ( .A(n4), .B(n5), .Y(n3) );
  XNOR2X1 U11 ( .A(rollover_val[1]), .B(next_count[1]), .Y(n5) );
  XNOR2X1 U12 ( .A(rollover_val[2]), .B(next_count[2]), .Y(n4) );
  NAND3X1 U13 ( .A(n6), .B(n12), .C(n13), .Y(n2) );
  XNOR2X1 U14 ( .A(rollover_val[0]), .B(next_count[0]), .Y(n13) );
  XNOR2X1 U15 ( .A(rollover_val[3]), .B(next_count[3]), .Y(n6) );
  OAI21X1 U16 ( .A(n14), .B(n15), .C(n16), .Y(next_count[3]) );
  ...
  OAI21X1 U21 ( .A(n22), .B(n23), .C(n24), .Y(next_count[2]) );
  ...
  OAI21X1 U26 ( .A(n29), .B(n30), .C(n31), .Y(next_count[1]) );
  ...
  OAI21X1 U33 ( .A(n28), .B(n15), .C(n33), .Y(next_count[0]) );
...
module flex_counter_NUM_CNT_BITS4_0 ( clk, n_rst, clear, count_enable, 
  ...
  XNOR2X1 U11 ( .A(rollover_val[2]), .B(next_count[2]), .Y(n3) );
  NAND3X1 U12 ( .A(n5), .B(n6), .C(n12), .Y(n1) );
  XNOR2X1 U13 ( .A(rollover_val[0]), .B(next_count[0]), .Y(n12) );
  XNOR2X1 U14 ( .A(rollover_val[3]), .B(next_count[3]), .Y(n5) );
  OAI21X1 U15 ( .A(n13), .B(n14), .C(n15), .Y(next_count[3]) );
  ...
  OAI21X1 U20 ( .A(n21), .B(n22), .C(n23), .Y(next_count[2]) );
  ...
  OAI21X1 U25 ( .A(n28), .B(n29), .C(n30), .Y(next_count[1]) );
  ...
  OAI21X1 U32 ( .A(n27), .B(n14), .C(n32), .Y(next_count[0]) );
...
module timer ( clk, n_rst, enable_timer, shift_enable, packet_done );
  ...
  flex_counter_NUM_CNT_BITS4_1 clk_count ( .clk(clk), .n_rst(n_rst), .clear(n1), .count_enable(enable_timer), .rollover_val({1'b1, 1'b0, 1'b1, 1'b0}), 
        .rollover_flag(shift_enable) );
  flex_counter_NUM_CNT_BITS4_0 bit_count ( .clk(clk), .n_rst(n_rst), .clear(n1), .count_enable(shift_enable), .rollover_val({1'b1, 1'b0, 1'b0, 1'b1}), 
...
module rcv_block ( clk, n_rst, serial_in, data_read, rx_data, data_ready, 
  ...
  wire   load_buffer, new_packet_detected, packet_done, sbc_clear, sbc_enable,
         enable_timer, stop_bit, shift_strobe;
  wire   [7:0] packet_data;

  rx_data_buff buffer ( .clk(clk), .n_rst(n_rst), .load_buffer(load_buffer), 
        .packet_data(packet_data), .data_read(data_read), .rx_data(rx_data), 
        .data_ready(data_ready), .overrun_error(overrun_error) );
  rcu controlUnit ( .clk(clk), .n_rst(n_rst), .new_packet_detected(
  ...
  stop_bit_chk check ( .clk(clk), .n_rst(n_rst), .sbc_clear(sbc_clear), 
  ...
  sr_9bit shift_register ( .clk(clk), .n_rst(n_rst), .shift_strobe(
        ...
        .stop_bit(stop_bit) );
  timer timing_control ( .clk(clk), .n_rst(n_rst), .enable_timer(enable_timer), 
        .shift_enable(shift_strobe), .packet_done(packet_done) );
  start_bit_det detector ( .clk(clk), .n_rst(n_rst), .serial_in(serial_in), 
